...
- `pwsh -NoProfile -File scripts/validate_engine_imports.ps1 -UnrealProject <project.uproject>`
...
- `pwsh -NoProfile -File scripts/create_engine_validation_projects.ps1 -OutputRoot target/midori_engine_validation_projects_smoke_portable -PortablePaths`
...
- `pwsh -NoProfile -File target/midori_engine_validation_handoff/run_editor_validation.ps1 -UnityExe "C:/Program Files/Unity/Hub/Editor/6000.4.9f1/Editor/Unity.exe" -UnityProject target/midori_engine_validation_handoff/projects/unity/MidoriUnityValidation -SkipUnreal -AllowPending`
