...
export class GroveGenerator {
    static __wrap(ptr) {
        const obj = Object.create(GroveGenerator.prototype);
        obj.__wbg_ptr = ptr;
        GroveGeneratorFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
     ...
     * @param {any} value
     * @returns {GroveGenerator}
     */
    static fromJson(value) {
        const ret = wasm.grovegenerator_fromJson(value);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return GroveGenerator.__wrap(ret[0]);
    }
    /**
     ...
     */
    toJson() {
        const ret = wasm.grovegenerator_toJson(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    toToml() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.grovegenerator_toToml(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
